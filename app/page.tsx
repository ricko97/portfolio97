...
import { Button, Card, CardFooter, Divider, Image, Link } from "@heroui/react";
...
export default function Home() {
  return (
    <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
      <section className="flex max-sm:flex-col flex-row items-center justify-between max-sm:gap-8 md:gap-16 lg:gap-16 px-4">
